...
const s = StyleSheet.create({
  ...
  expTitle: { fontFamily: "Helvetica-Bold", fontSize: 10, color: "#1f2937" },
  expOrg: { color: "#6b7280", fontSize: 10 },
  expDate: { fontSize: 8, color: "#10b981", fontFamily: "Helvetica-Bold" },
  bullet: { flexDirection: "row", marginLeft: 4, marginTop: 2 },
  bulletDot: { width: 8, fontSize: 10, color: "#4b5563" },
  bulletText: { flex: 1, fontSize: 10, color: "#4b5563" },
  techRow: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 4,
  ...
  col: { flex: 1 },
  eduDegree: { fontFamily: "Helvetica-Bold", fontSize: 9.5, color: "#1f2937" },
  eduInst: { fontSize: 8.5, color: "#6b7280" },
  eduDate: { fontSize: 8, color: "#10b981", fontFamily: "Helvetica-Bold" },
  eduDetails: { fontSize: 8, color: "#9ca3af" },
  certItem: {
    flexDirection: "row",
    alignItems: "flex-start",
    marginBottom: 4,
  },
  certCheck: { fontSize: 9, color: "#10b981", marginRight: 6 },
  certText: { fontSize: 9, color: "#374151", flex: 1 },
});
